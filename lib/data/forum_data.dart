  ...
  static final schedule = <List<ForumEvent>>[
    ...
    [
      ForumEvent(
        ...
        type: DirectionType.NONE,
        venue: "Гостиницы",
        start: DateTime(2019, 12, 11, 7, 00),
        end: DateTime(2019, 12, 11, 8, 00),
      ),
      ForumEvent(
      ...
      ForumEvent(
        ...
        type: DirectionType.NONE,
        venue: "Арена. Классы",
        start: DateTime(2019, 12, 11, 9, 00),
        end: DateTime(2019, 12, 11, 9, 30),
      ),
      ForumEvent(
        name: "Торжественное открытие деловой образовательной программы",
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 10, 00),
        end: DateTime(2019, 12, 11, 10, 15),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 10, 15),
        end: DateTime(2019, 12, 11, 10, 30),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 10, 30),
        end: DateTime(2019, 12, 11, 10, 45),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 10, 45),
        end: DateTime(2019, 12, 11, 11, 00),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 11, 00),
        end: DateTime(2019, 12, 11, 11, 15),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 11, 15),
        end: DateTime(2019, 12, 11, 11, 30),
      ),
      ForumEvent(
        name:
        ...
        type: DirectionType.NONE,
        venue: "Арена. Главный зал",
        start: DateTime(2019, 12, 11, 11, 30),
        end: DateTime(2019, 12, 11, 11, 45),
      ),
      ForumEvent(
        name: "Обед",
        type: DirectionType.NONE,
        venue: "Ресторан «Волга-Волга»",
        start: DateTime(2019, 12, 11, 11, 45),
        end: DateTime(2019, 12, 11, 13, 45),
      ),
      ForumEvent(
        name: "Космические технологии",
        type: DirectionType.SPACE,
        venue: "Арена. Классы",
        start: DateTime(2019, 12, 11, 13, 45),
        end: DateTime(2019, 12, 11, 16, 30),
      ),
      ForumEvent(
